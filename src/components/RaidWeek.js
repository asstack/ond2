...
const RaidWeek = ({ characterActivities, handleSetFarmCount, handleFetchPGCR, viewRaid, raidWeek, raid, characters, maxSuccessRaids, handleSetMaxSuccessRaids, weekTitle }) => {
